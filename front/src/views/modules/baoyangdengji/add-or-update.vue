    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="保养登记唯一编号" prop="baoyangdengjiUuidNumber">
                       <el-input v-model="ruleForm.baoyangdengjiUuidNumber"
                                 placeholder="保养登记唯一编号" clearable  :readonly="ro.baoyangdengjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="保养登记唯一编号" prop="baoyangdengjiUuidNumber">
                           <el-input v-model="ruleForm.baoyangdengjiUuidNumber"
                                     placeholder="保养登记唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="保养名称" prop="baoyangdengjiName">
                       <el-input v-model="ruleForm.baoyangdengjiName"
                                 placeholder="保养名称" clearable  :readonly="ro.baoyangdengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="保养名称" prop="baoyangdengjiName">
                           <el-input v-model="ruleForm.baoyangdengjiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="保养类型" prop="baoyangdengjiTypes">
                        <el-select v-model="ruleForm.baoyangdengjiTypes" :disabled="ro.baoyangdengjiTypes" placeholder="请选择保养类型">
                            <el-option
                                v-for="(item,index) in baoyangdengjiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="保养类型" prop="baoyangdengjiValue">
                        <el-input v-model="ruleForm.baoyangdengjiValue"
                            placeholder="保养类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="保养详情" prop="baoyangdengjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.baoyangdengjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.baoyangdengjiContent" label="保养详情" prop="baoyangdengjiContent">
                            <span v-html="ruleForm.baoyangdengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="保养时间" prop="baoyangdengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.baoyangdengjiTime"
                                type="datetime"
                                placeholder="保养时间"
                                :disabled="ro.baoyangdengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.baoyangdengjiTime" label="保养时间" prop="baoyangdengjiTime">
                            <span v-html="ruleForm.baoyangdengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yuangongId: false,
                    baoyangdengjiUuidNumber: false,
                    baoyangdengjiName: false,
                    baoyangdengjiTypes: false,
                    baoyangdengjiContent: false,
                    baoyangdengjiTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yuangongId: '',
                    baoyangdengjiUuidNumber: new Date().getTime(),
                    baoyangdengjiName: '',
                    baoyangdengjiTypes: '',
                    baoyangdengjiContent: '',
                    baoyangdengjiTime: '',
                    insertTime: '',
                },
                baoyangdengjiTypesOptions : [],
                yonghuOptions : [],
                yuangongOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   baoyangdengjiUuidNumber: [
                              { required: true, message: '保养登记唯一编号不能为空', trigger: 'blur' },
                          ],
                   baoyangdengjiName: [
                   ...
                   baoyangdengjiContent: [
                              { required: true, message: '保养详情不能为空', trigger: 'blur' },
                          ],
                   baoyangdengjiTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=baoyangdengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.baoyangdengjiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`baoyangdengji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.baoyangdengjiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
