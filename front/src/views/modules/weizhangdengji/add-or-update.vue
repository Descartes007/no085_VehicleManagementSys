    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="违章登记唯一编号" prop="weizhangdengjiUuidNumber">
                       <el-input v-model="ruleForm.weizhangdengjiUuidNumber"
                                 placeholder="违章登记唯一编号" clearable  :readonly="ro.weizhangdengjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="违章登记唯一编号" prop="weizhangdengjiUuidNumber">
                           <el-input v-model="ruleForm.weizhangdengjiUuidNumber"
                                     placeholder="违章登记唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="违章名称" prop="weizhangdengjiName">
                       <el-input v-model="ruleForm.weizhangdengjiName"
                                 placeholder="违章名称" clearable  :readonly="ro.weizhangdengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="违章名称" prop="weizhangdengjiName">
                           <el-input v-model="ruleForm.weizhangdengjiName"
                                     placeholder="违章名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="违章类型" prop="weizhangdengjiTypes">
                        <el-select v-model="ruleForm.weizhangdengjiTypes" :disabled="ro.weizhangdengjiTypes" placeholder="请选择违章类型">
                            <el-option
                                v-for="(item,index) in weizhangdengjiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="违章类型" prop="weizhangdengjiValue">
                        <el-input v-model="ruleForm.weizhangdengjiValue"
                            placeholder="违章类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="违章详情" prop="weizhangdengjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.weizhangdengjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weizhangdengjiContent" label="违章详情" prop="weizhangdengjiContent">
                            <span v-html="ruleForm.weizhangdengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="处罚详情" prop="chufaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chufaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chufaContent" label="处罚详情" prop="chufaContent">
                            <span v-html="ruleForm.chufaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="违章时间" prop="weizhangdengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.weizhangdengjiTime"
                                type="datetime"
                                placeholder="违章时间"
                                :disabled="ro.weizhangdengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weizhangdengjiTime" label="违章时间" prop="weizhangdengjiTime">
                            <span v-html="ruleForm.weizhangdengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yuangongId: false,
                    weizhangdengjiUuidNumber: false,
                    weizhangdengjiName: false,
                    weizhangdengjiTypes: false,
                    weizhangdengjiContent: false,
                    chufaContent: false,
                    weizhangdengjiTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yuangongId: '',
                    weizhangdengjiUuidNumber: new Date().getTime(),
                    weizhangdengjiName: '',
                    weizhangdengjiTypes: '',
                    weizhangdengjiContent: '',
                    chufaContent: '',
                    weizhangdengjiTime: '',
                    insertTime: '',
                },
                weizhangdengjiTypesOptions : [],
                yonghuOptions : [],
                yuangongOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   weizhangdengjiUuidNumber: [
                              { required: true, message: '违章登记唯一编号不能为空', trigger: 'blur' },
                          ],
                   weizhangdengjiName: [
                              { required: true, message: '违章名称不能为空', trigger: 'blur' },
                          ],
                   weizhangdengjiTypes: [
                   ...
                   weizhangdengjiContent: [
                              { required: true, message: '违章详情不能为空', trigger: 'blur' },
                          ],
                   chufaContent: [
                              { required: true, message: '处罚详情不能为空', trigger: 'blur' },
                          ],
                   weizhangdengjiTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=weizhangdengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.weizhangdengjiTypesOptions = data.data.list;
                    }
                });
