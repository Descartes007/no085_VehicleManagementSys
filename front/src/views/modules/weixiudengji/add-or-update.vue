    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修登记唯一编号" prop="weixiudengjiUuidNumber">
                       <el-input v-model="ruleForm.weixiudengjiUuidNumber"
                                 placeholder="维修登记唯一编号" clearable  :readonly="ro.weixiudengjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="维修登记唯一编号" prop="weixiudengjiUuidNumber">
                           <el-input v-model="ruleForm.weixiudengjiUuidNumber"
                                     placeholder="维修登记唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修名称" prop="weixiudengjiName">
                       <el-input v-model="ruleForm.weixiudengjiName"
                                 placeholder="维修名称" clearable  :readonly="ro.weixiudengjiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="维修名称" prop="weixiudengjiName">
                           <el-input v-model="ruleForm.weixiudengjiName"
                                     placeholder="维修名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="维修类型" prop="weixiudengjiTypes">
                        <el-select v-model="ruleForm.weixiudengjiTypes" :disabled="ro.weixiudengjiTypes" placeholder="请选择维修类型">
                            <el-option
                                v-for="(item,index) in weixiudengjiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="维修类型" prop="weixiudengjiValue">
                        <el-input v-model="ruleForm.weixiudengjiValue"
                            placeholder="维修类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="维修详情" prop="weixiudengjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.weixiudengjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weixiudengjiContent" label="维修详情" prop="weixiudengjiContent">
                            <span v-html="ruleForm.weixiudengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="维修时间" prop="weixiudengjiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.weixiudengjiTime"
                                type="datetime"
                                placeholder="维修时间"
                                :disabled="ro.weixiudengjiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weixiudengjiTime" label="维修时间" prop="weixiudengjiTime">
                            <span v-html="ruleForm.weixiudengjiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yuangongId: false,
                    weixiudengjiUuidNumber: false,
                    weixiudengjiName: false,
                    weixiudengjiTypes: false,
                    weixiudengjiContent: false,
                    weixiudengjiTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yuangongId: '',
                    weixiudengjiUuidNumber: new Date().getTime(),
                    weixiudengjiName: '',
                    weixiudengjiTypes: '',
                    weixiudengjiContent: '',
                    weixiudengjiTime: '',
                ...
                rules: {
                   ...
                   weixiudengjiUuidNumber: [
                              { required: true, message: '维修登记唯一编号不能为空', trigger: 'blur' },
                          ],
                   weixiudengjiName: [
                              { required: true, message: '维修名称不能为空', trigger: 'blur' },
                          ],
                   weixiudengjiTypes: [
                   ...
                   weixiudengjiContent: [
                              { required: true, message: '维修详情不能为空', trigger: 'blur' },
                          ],
                   weixiudengjiTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=weixiudengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.weixiudengjiTypesOptions = data.data.list;
                    }
                });
