        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="准驾车型" prop="zhunjiaTypes">
                        <el-select v-model="ruleForm.zhunjiaTypes" :disabled="ro.zhunjiaTypes" placeholder="请选择准驾车型">
                            <el-option
                                v-for="(item,index) in zhunjiaTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="驾驶证" prop="jiashizhenghao">
                       <el-input v-model="ruleForm.jiashizhenghao"
                                 placeholder="驾驶证" clearable  :readonly="ro.jiashizhenghao"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="用户备注" prop="yonghuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yonghuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuContent" label="用户备注" prop="yonghuContent">
                            <span v-html="ruleForm.yonghuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhunjia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhunjiaTypesOptions = data.data.list;
                    }
                });
